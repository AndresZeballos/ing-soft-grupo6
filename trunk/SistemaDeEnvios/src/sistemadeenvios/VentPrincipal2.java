 ...
 * @author Andres
 */
public class VentPrincipal2 extends javax.swing.JFrame {

    /** Creates new form VentPrincipal2 */
    public VentPrincipal2() {
        initComponents();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (!codigo.equals("")){
            try {
                ...
                Logger.getLogger(VentPrincipal2.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VentPrincipal2().setVisible(true);
            }
        });
    }
